    ...
    def common_formatting_rules(self) -> str:
        if self.language == "Chi":
            return (
                ...
                "多期趋势句中如某一期金额为零，该期应写作'未发生'或'无'，不要写成'人民币0.0万元'。"
        ...
        return (
            ...
            "In a multi-period trend sentence, a period with a zero amount should read as 'nil' rather than 'CNY0.0 million'/'CNY0'. "
