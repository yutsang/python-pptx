...
def main() -> int:
    ...
    para_gap = 3.0  # keep in lockstep with fdd_utils/pptx.py's _real_para_gap_pt (2026-08-04)
    ...
    for i, p in enumerate(shape.text_frame.paragraphs):
        ...
        p_para_gap = 3.0  # keep in lockstep with fdd_utils/pptx.py's _real_para_gap_pt (2026-08-04)
