...
def run_streamlit():
    ...
    if main_app.exists():
        print("🎯 Running main application with complete functionality...")
        os.system(f"streamlit run {main_app}")
    elif full_app.exists():
        ...
        print("   - streamlit run streamlit_app.py         (main application)")
